...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-3/4 right-1/4 w-16 h-16 border-2 border-secondary/30 rounded-full animate-float" style={{ animationDelay: '1s' }}></div>
      <div className="absolute top-1/2 right-1/6 w-12 h-12 border-2 border-primary/20 rotate-45 animate-float" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        <div className="space-y-8">
          ...
          <div className="mx-auto w-48 h-48 rounded-full overflow-hidden glow-cyan animate-fade-in-up">
            <img 
              src="/lovable-uploads/c38b35ff-f521-4aa9-b80a-44e23ef056b7.png" 
              alt="Varun Venkatapuram"
          ...
          <div className="space-y-4 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <h1 className="text-5xl md:text-7xl font-orbitron font-black tracking-wide">
              ...
              <br />
              <span className="text-foreground">Venkatapuram</span>
            </h1>
            <p className="text-xl md:text-2xl font-exo text-primary font-semibold tracking-wide">
              Full Stack Java Developer | Cloud & AI Solutions
            </p>
          </div>
          ...
          <div className="pt-12 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {['Java', 'Spring Boot', 'React', 'AWS', 'Kubernetes', 'AI/ML'].map((tech, index) => (
                <span 
                  key={tech} 
